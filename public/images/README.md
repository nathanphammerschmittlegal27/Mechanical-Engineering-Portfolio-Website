...
- `autonomous-drone-frame-detail-1.webp` - Detail image 1
- `autonomous-drone-frame-detail-2.webp` - Detail image 2
...
2. **Update the image URLs** in `src/data/projects.ts`:
   ...
   - Example: `detailImages: [{ imageUrl: '/images/project-detail-1.webp', aspectRatio: 'auto' }]`
...
- **Detail images**: 800x600px or larger (4:3 aspect ratio)
